...
export function ContractPage({bookGenres}) {
  return (
    <div className='wrapper wrapper--contract'>
      <Container className='container--contract'>
        <Menu bookGenres={bookGenres} current='contract' />
        <div className="contract">
          <h2 className="contract-title">Договор оферты</h2>
          <ol className="contract-list contract-list-main">
            <li className='list-text--main'>
              ...
              <ol className='contract-list contract-list--sub'>
